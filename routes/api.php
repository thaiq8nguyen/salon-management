...
Route::post('/technician-sale/handle-quick-sale',
    'TechnicianSaleApiController@handleQuickSale')->middleware('auth:api');
...
Route::get('/technician-wage/pay-period/{payPeriod}/technician/{technician}',
    'PayDayApiController@searchWageByPeriod')->middleware('auth:api');

Route::get('/technician-payment/pay-period/{payPeriod}/technician/{technician}',
    'PayDayApiController@searchPaymentByPeriod')->middleware('auth:api');
...
Route::get('/technician-payment/report/by-technician',
    'PaymentReportApiController@byTechnician')->middleware('auth:api');

Route::post('/technician-payment/report/create', 'PaymentReportController@create')->middleware('auth:api');

/*Pay Period Api Controller*/

Route::get('/technician-pay-period/search', 'PayPeriodApiController@report')->middleware('auth:api');

Route::get('/technician-pay-period/update', 'PayPeriodApiController@update')->middleware('auth:api');
